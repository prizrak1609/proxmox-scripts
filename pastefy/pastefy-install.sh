...
$STD echo "     restart: always" >> docker-compose.override.yml
$STD sed -i "s/SERVER_NAME: \"http:\/\/localhost:9999\"/SERVER_NAME: \"https:\/\/snippets.ollaris.org\"/" docker-compose.yml
