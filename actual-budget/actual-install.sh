...
msg_info "Installing Mono-to-Actual"
$STD mkdir -p /home/mono-to-actual
$STD git clone https://github.com/prizrak1609/mono-to-actualbudget.git /home/mono-to-actual/
$STD cd /home/mono-to-actual
$STD npm install
msg_ok "Installed Mono-to-Actual"
